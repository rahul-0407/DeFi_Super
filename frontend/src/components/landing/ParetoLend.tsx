      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 bg-[#d7e4ea] backdrop-blur-md rounded-[3rem] p-12 border border-white/60 relative overflow-hidden min-h-[600px] flex flex-col justify-between">
            <div>
              <h2 className="text-5xl font-serif text-deep-green leading-tight mb-8">
                Lend
              </h2>
              <p className=" text-deep-green leading-relaxed text-xl tracking-wide max-w-xs">
                Expand your fixed-income portfolio with structured yield
                strategies tailored to diverse risk profiles. Participate
                permissionlessly in our on-chain lending pools with instant
                liquidity and variable interest.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              <button className="px-8 py-3 rounded-full border border-neutral-900 text-[11px] font-bold  tracking-widest hover:bg-neutral-900 hover:text-white transition-all">
                Open in App
              </button>
              <button className="px-8 py-3 rounded-full border border-neutral-900 text-[11px] font-bold tracking-widest hover:bg-neutral-900 hover:text-white transition-all">
                Documents
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-40 pt-16 mt-12">
            {[
              {
                num: "1",
                title: "Explore Asset Pools",
                desc: "Each market is uniquely structured based on supported collateral, interest rate models, and liquidity parameters.",
              },
              {
                num: "2",
              ...
              {
                num: "4",
                title: "Permissionless Market Entry",
                desc: "Access individual pools directly through on-chain protocols, ensuring speed and transparency.",
              },
            ].map((step, i) => (
              <motion.div
                key={i}
