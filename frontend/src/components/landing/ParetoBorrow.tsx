      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 bg-[#dbdfe7] backdrop-blur-md rounded-[3rem] p-12 border border-white/60 relative overflow-hidden min-h-[600px] flex flex-col justify-between">
            <div>
              <h2 className="text-6xl font-serif text-deep-green leading-tight mb-8">
                Borrow
              </h2>
              <p className="text-xl text-neutral-500 leading-relaxed  tracking-wide max-w-xs">
                Streamline the creation and securitization of your credit -
                interest rates, collateral ratios, and risk-adjusted tranches:
                construct the credit line that works best for you.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              <button className="px-10 py-3 rounded-full border border-deep-green text-[11px] font-bold uppercase tracking-widest hover:bg-deep-green hover:text-white transition-all">
                Open in App
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-40 pt-12 mt-10">
            {[
              {
                num: "1",
                title: "Initialize Credit",
                desc: "Provide on-chain collateral and open a permissionless credit line instantly.",
              },
              {
                num: "2",
                title: "Vault Configuration",
                desc: "Borrowers set key parameters like loan duration, interest rate model, health factor thresholds, and collateral ratios.",
              },
              {
                num: "3",
